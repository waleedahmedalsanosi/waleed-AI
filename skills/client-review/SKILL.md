...
Run after `/prd` and `/sow`. Produces a founder-facing review package at `08-client-review.md`
...
1. `04-prd.md` — Product Requirements Document
2. `05-sow.md` — Scope of Work

### Step 2: Write 08-client-review.md

Write to `{SESSION}/08-client-review.md`:
...
File: {session path}/08-client-review.md
